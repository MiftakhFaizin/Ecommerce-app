        ...
        <div className="flex justify-center max-md:sticky max-md:top-0 max-md:bg-white max-md:bg-opacity-70 max-md:backdrop-blur-sm max-md:z-20">
            <div className="container px-[40px] py-[15px]">
                <div className="flex justify-between">
                    ...
                    <ul className={`flex gap-[15px] items-center max-md:fixed max-md:items-start max-md:bg-black max-md:shadow-lg max-md:shadow-white max-md:-left-[80%] ${hamburgerMenu && "translate-x-[80%]"} max-md:top-0 max-md:h-[100vh] ${hamburgerMenu && "max-md:w-[90%]"} max-md:flex-col max-md:gap-[40px] max-md:pt-[50px] max-md:pl-[20%] transition-all duration-200 ease-linear`}>
